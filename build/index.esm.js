...
var QuillEditor = function QuillEditor(props) {
  var fieldClassName = classNames(Styles$4.container, props.className, props.locked && Styles$4.locked);
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: classNames(Styles$4.base, Styles$4.quill, QuillStyles.editor),
    id: props.name,
    name: props.name,
    ...
    htmlFor: props.name,
    className: classNames(Styles$4.label, props.error && Styles$4.error)
...
export { Button, Card, Icon, InputContainer, InputGroup, Loader, Logo, QuillEditor as Quill, Segment as SegmentedControl, SelectInput as Select, Text$2 as Text, TextArea, TextInput, Toggle, theme as evergreenTheme };
