...
Icon.Google = /*#__PURE__*/memo(SvgGoogleinline);
Icon.Facebook = /*#__PURE__*/memo(SvgFacebookinline);
Icon.Twitter = /*#__PURE__*/memo(SvgTwitterinline);
Icon.Linkedin = /*#__PURE__*/memo(SvgLinkedininline);
Icon.Instagram = /*#__PURE__*/memo(SvgInstagraminline);
Icon.Youtube = /*#__PURE__*/memo(SvgYoutubeinline);
Icon.Word = /*#__PURE__*/memo(SvgWordinline);
Icon.Audio = /*#__PURE__*/memo(SvgAudioinline);
Icon.Excel = /*#__PURE__*/memo(SvgExcelinline);
Icon.File = /*#__PURE__*/memo(SvgFileinline);
Icon.Pdf = /*#__PURE__*/memo(SvgPdfinline);
Icon.Attachment = /*#__PURE__*/memo(SvgAttachmentinline);
Icon.Search = /*#__PURE__*/memo(SvgSearchinline);
Icon.Close = /*#__PURE__*/memo(SvgCloseinline);
Icon.Org = /*#__PURE__*/memo(SvgOrginline);
Icon.Timesheet = /*#__PURE__*/memo(SvgTimesheetinline);
Icon.Brief = /*#__PURE__*/memo(SvgBriefinline);
Icon.Skill = /*#__PURE__*/memo(SvgSkillinline);
Icon.Chat = /*#__PURE__*/memo(SvgChatinline);
Icon.Expand = /*#__PURE__*/memo(SvgExpandinline);
Icon.Minimize = /*#__PURE__*/memo(SvgMinimizeinline);
Icon.Project = /*#__PURE__*/memo(SvgProjectinline);
Icon.Assessment = /*#__PURE__*/memo(SvgAssessmentinline);
Icon.Talent = /*#__PURE__*/memo(SvgTalentinline);
Icon.Profile = /*#__PURE__*/memo(SvgProfileinline);
Icon.ChatUsers = /*#__PURE__*/memo(SvgChatUsersinline);
Icon.Download = /*#__PURE__*/memo(SvgDownloadinline);
Icon.Down = /*#__PURE__*/memo(SvgDowninline);
Icon.Company = /*#__PURE__*/memo(SvgCompanyinline);
Icon.Dashboard = /*#__PURE__*/memo(SvgDashboardinline);
Icon.Guide = /*#__PURE__*/memo(SvgGuideinline);
Icon.Reference = /*#__PURE__*/memo(SvgReferenceinline);
Icon.Caret = /*#__PURE__*/memo(SvgCaretinline);
Icon.Link = /*#__PURE__*/memo(SvgLinkinline);
Icon.Pencil = /*#__PURE__*/memo(SvgPencilinline);
Icon.Edit = /*#__PURE__*/memo(SvgPencilinline);
Icon.Picture = /*#__PURE__*/memo(SvgPictureinline);
Icon.StarEmpty = /*#__PURE__*/memo(SvgStaremptyinline);
Icon.StarFull = /*#__PURE__*/memo(SvgStarfullinline);
Icon.External = /*#__PURE__*/memo(SvgExternalinline);
Icon.Activity = /*#__PURE__*/memo(SvgActivityinline);
Icon.Notification = /*#__PURE__*/memo(SvgNotificationinline);
Icon.Ok = /*#__PURE__*/memo(SvgOkinline);
Icon.Phone = /*#__PURE__*/memo(SvgPhoneinline);
Icon.Email = /*#__PURE__*/memo(SvgEmailinline);
Icon.Add = /*#__PURE__*/memo(SvgAddinline);
Icon.More = /*#__PURE__*/memo(SvgMoreinline);
Icon.MoreVertical = /*#__PURE__*/memo(SvgMoreVerticalinline);
Icon.Settings = /*#__PURE__*/memo(SvgSettingsinline);
Icon.Question = /*#__PURE__*/memo(SvgQuestioninline);
Icon.Intercom = /*#__PURE__*/memo(SvgQuestioninline); // Fallback

Icon.Text = /*#__PURE__*/memo(SvgTextinline);
Icon.Logout = /*#__PURE__*/memo(SvgLogoutinline);
Icon.Menu = /*#__PURE__*/memo(SvgMenuinline);
Icon.Drag = /*#__PURE__*/memo(SvgDraginline);
Icon.Preview = /*#__PURE__*/memo(SvgPreviewinline);
Icon.Xero = /*#__PURE__*/memo(SvgXeroinline);
Icon.Refresh = /*#__PURE__*/memo(SvgRefreshinline);
Icon.Filter = /*#__PURE__*/memo(SvgFilterinline);
Icon.Split = /*#__PURE__*/memo(SvgSplitinline);
Icon.Invoice = /*#__PURE__*/memo(SvgInvoiceinline);
Icon.Play = /*#__PURE__*/memo(SvgPlayinline);
Icon.Stop = /*#__PURE__*/memo(SvgStopinline);
