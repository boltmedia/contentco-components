...
Icon.Google = /*#__PURE__*/React.memo(SvgGoogleinline);
Icon.Facebook = /*#__PURE__*/React.memo(SvgFacebookinline);
Icon.Twitter = /*#__PURE__*/React.memo(SvgTwitterinline);
Icon.Linkedin = /*#__PURE__*/React.memo(SvgLinkedininline);
Icon.Instagram = /*#__PURE__*/React.memo(SvgInstagraminline);
Icon.Youtube = /*#__PURE__*/React.memo(SvgYoutubeinline);
Icon.Word = /*#__PURE__*/React.memo(SvgWordinline);
Icon.Audio = /*#__PURE__*/React.memo(SvgAudioinline);
Icon.Excel = /*#__PURE__*/React.memo(SvgExcelinline);
Icon.File = /*#__PURE__*/React.memo(SvgFileinline);
Icon.Pdf = /*#__PURE__*/React.memo(SvgPdfinline);
Icon.Attachment = /*#__PURE__*/React.memo(SvgAttachmentinline);
Icon.Search = /*#__PURE__*/React.memo(SvgSearchinline);
Icon.Close = /*#__PURE__*/React.memo(SvgCloseinline);
Icon.Org = /*#__PURE__*/React.memo(SvgOrginline);
Icon.Timesheet = /*#__PURE__*/React.memo(SvgTimesheetinline);
Icon.Brief = /*#__PURE__*/React.memo(SvgBriefinline);
Icon.Skill = /*#__PURE__*/React.memo(SvgSkillinline);
Icon.Chat = /*#__PURE__*/React.memo(SvgChatinline);
Icon.Expand = /*#__PURE__*/React.memo(SvgExpandinline);
Icon.Minimize = /*#__PURE__*/React.memo(SvgMinimizeinline);
Icon.Project = /*#__PURE__*/React.memo(SvgProjectinline);
Icon.Assessment = /*#__PURE__*/React.memo(SvgAssessmentinline);
Icon.Talent = /*#__PURE__*/React.memo(SvgTalentinline);
Icon.Profile = /*#__PURE__*/React.memo(SvgProfileinline);
Icon.ChatUsers = /*#__PURE__*/React.memo(SvgChatUsersinline);
Icon.Download = /*#__PURE__*/React.memo(SvgDownloadinline);
Icon.Down = /*#__PURE__*/React.memo(SvgDowninline);
Icon.Company = /*#__PURE__*/React.memo(SvgCompanyinline);
Icon.Dashboard = /*#__PURE__*/React.memo(SvgDashboardinline);
Icon.Guide = /*#__PURE__*/React.memo(SvgGuideinline);
Icon.Reference = /*#__PURE__*/React.memo(SvgReferenceinline);
Icon.Caret = /*#__PURE__*/React.memo(SvgCaretinline);
Icon.Link = /*#__PURE__*/React.memo(SvgLinkinline);
Icon.Pencil = /*#__PURE__*/React.memo(SvgPencilinline);
Icon.Edit = /*#__PURE__*/React.memo(SvgPencilinline);
Icon.Picture = /*#__PURE__*/React.memo(SvgPictureinline);
Icon.StarEmpty = /*#__PURE__*/React.memo(SvgStaremptyinline);
Icon.StarFull = /*#__PURE__*/React.memo(SvgStarfullinline);
Icon.External = /*#__PURE__*/React.memo(SvgExternalinline);
Icon.Activity = /*#__PURE__*/React.memo(SvgActivityinline);
Icon.Notification = /*#__PURE__*/React.memo(SvgNotificationinline);
Icon.Ok = /*#__PURE__*/React.memo(SvgOkinline);
Icon.Phone = /*#__PURE__*/React.memo(SvgPhoneinline);
Icon.Email = /*#__PURE__*/React.memo(SvgEmailinline);
Icon.Add = /*#__PURE__*/React.memo(SvgAddinline);
Icon.More = /*#__PURE__*/React.memo(SvgMoreinline);
Icon.MoreVertical = /*#__PURE__*/React.memo(SvgMoreVerticalinline);
Icon.Settings = /*#__PURE__*/React.memo(SvgSettingsinline);
Icon.Question = /*#__PURE__*/React.memo(SvgQuestioninline);
Icon.Intercom = /*#__PURE__*/React.memo(SvgQuestioninline); // Fallback

Icon.Text = /*#__PURE__*/React.memo(SvgTextinline);
Icon.Logout = /*#__PURE__*/React.memo(SvgLogoutinline);
Icon.Menu = /*#__PURE__*/React.memo(SvgMenuinline);
Icon.Drag = /*#__PURE__*/React.memo(SvgDraginline);
Icon.Preview = /*#__PURE__*/React.memo(SvgPreviewinline);
Icon.Xero = /*#__PURE__*/React.memo(SvgXeroinline);
Icon.Refresh = /*#__PURE__*/React.memo(SvgRefreshinline);
Icon.Filter = /*#__PURE__*/React.memo(SvgFilterinline);
Icon.Split = /*#__PURE__*/React.memo(SvgSplitinline);
Icon.Invoice = /*#__PURE__*/React.memo(SvgInvoiceinline);
Icon.Play = /*#__PURE__*/React.memo(SvgPlayinline);
Icon.Stop = /*#__PURE__*/React.memo(SvgStopinline);
...
var Action = function Action(_ref) {
  ...
  return /*#__PURE__*/React__default['default'].createElement("div", _extends__default['default']({
    className: classNames__default['default'](Styles$7.action, className)
  }, props), children);
};
